...
import { SettingsUpdateResults } from "../settings/structures/SettingsFolder";
import { objectToTuples } from "../util/Utils";
...
export abstract class SQLProvider extends Provider {
	...
	/**
	 * Process the input from {@link Settings.update Settings#update} or {@link Settings.reset Settings#reset} into an object with the keys and values
