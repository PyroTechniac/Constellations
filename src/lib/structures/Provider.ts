...
import type { SettingsUpdateResults } from '../settings/structures/SettingsFolder';
import type { SchemaEntry } from '../settings/schema/SchemaEntry';
import type { SchemaFolder } from '../settings/schema/SchemaFolder';
import type { KeyedObject } from '../util/SharedTypes';
import { mergeObjects, makeObject } from '../util/Utils';
...
export abstract class Provider extends Piece {
	 ...
	 * @param table The table to check against
	 */
	public abstract hasTable(table: string): Promise<unknown>;
 ...
 */
	...
	/**
	 * Shutdown method, this is called before the Provider is unloaded.
	 */
	...
	/**
	 * Process the input from {@link Settings.update Settings#update} or {@link Settings.reset Settings#reset} into a plain object that can be used for
